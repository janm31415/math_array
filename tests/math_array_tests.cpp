...
struct math_array4x4_fixture
{
  math_array4x4_fixture()
  {
    for (int i = 0; i < 16; ++i)
    {
      ...
      b[i] = static_cast<T>(a[i]*2);
      c[i] = static_cast<T>(i+1);
    }
    c[14] = -1;
    c[7] = -3;
    v = {{1,2,3,1}};
...
void run_all_quaternion_tests()
{
  ...
  rx = {{0.0f, 0.1f, 0.2f, 0.3f, 0.4f, -0.1f, -0.2f, -0.3f, -0.4f, 0.5f, 0.6f, 0.7f, 0.8f, 0.9f, -0.5f, -0.6f, -0.7f, -0.8f, -0.9f, 1.0f}};
  ry = { {0.0f, 0.0f, 0.1f, 0.1f, 0.2f, 0.2f, 0.3f, 0.3f, -0.1f, -0.1f, -0.2f, -0.2f, -0.3f, -0.3f, -0.4f, -0.4f, 0.7f, 0.8f, 0.9f, 1.0f} };
  rz = { {1.0f, 0.9f, 0.8f, 0.7f, -1.0f, -0.9f, -0.8f, -0.7f, 0.6f, 0.5f, 0.4f, 0.3f, -0.6f, -0.5f, -0.4f, -0.3f, 0.1f, 0.0f, -0.1f, -0.9f} };
